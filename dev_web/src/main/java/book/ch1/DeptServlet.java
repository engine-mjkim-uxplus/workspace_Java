...
public class DeptServlet extends HttpServlet{
	...
	throws ServletException, IOException{
		...
		// 결론적으로 서버는 요청이 유지되지 않았다
		// 반대로 forward로 페이지를 이동 오청하면
		// 주소 URL(dept/dept.ds)은 그대로 있는데 응답페이지는 dept/deptList.jsp가 출력되는 것을 보면
		// 서버 입장에서는 사용자의 요청이 아직 계속 유지되고 있는 것으로 판단함
