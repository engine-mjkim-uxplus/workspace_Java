...
<!-- ####################  로그인 영역 시작 #######################-->
			...
			<div style="margin: 3px 0;"></div>
			<a id="btn_login" href="javascript:login()" class="easyui-linkbutton" data-option="iconCls:'icon-man'">
			로그인
			</a>
			<a id="btn_member" href="javascript:memberShip()" class="easyui-linkbutton" data-option="iconCls:'icon-add'">
			회원가입
			</a>
			</div>
<!-- ####################  로그인 영역 끝 #######################-->
...
<!-- ####################  로그아웃 영역 시작#######################-->  
					<div id="d_logout" align="center">
						...
						<div style="margin:3px 0"></div>
						<a id="btn_logout" href="javascript:logout()" class="easyui-linkbutton" data-option="iconCls:'icon-cancel'">
						로그아웃
						</a>
						<a id="btn_member" href="javascript:memberUpdate()" class="easyui-linkbutton" data-option="iconCls:'icon-edit'">
						정보수정
						</a>						
					</div>
<!-- ####################  로그아웃 영역 끝 #######################-->
