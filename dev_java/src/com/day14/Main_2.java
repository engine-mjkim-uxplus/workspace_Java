...
public class Main_2 extends JFrame implements ActionListener {
	...
	public void initDisplay() {
		dialog = new Dialog_2(); // 생성자 없음으로 그냥 넘어감
		...
		btnInsert.addActionListener(this); // actionPerformed와 연결시켜 준다. 버튼이 눌러졌을때 콜백(시슴템이 자동으로 호출) actionPerformed.
	...
	/*
	 * 36 -37 (인스턴스화: 디폴트[파라미터가 없는 생성자] 생성자 호출) -생성자 정의되지 않았다 --제공된다 (jdk11컴파일러) -
	 * 38(hot spot) 19-20(인.화[Dialog_1]) - {21-31:화면그리기-분석하지마라:UserInterface}
	 */
	public static void main(String[] args) {
		Main_2 abook = new Main_2();
	abook.initDisplay();  // where? 생성자로 보냄
	}
